...
# Date: Tue, 22 Aug 2023 10:30:21 GMT
#set_units -time ns
...
create_generated_clock -name {ADC_theACLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 61 121} [list [get_pins {ClockBlock/aclk_glb_0}]]
...
create_generated_clock -name {Clock2} -source [get_pins {ClockBlock/clk_sync}] -edges {1 601 1201} -nominal_period 9999.9999999999982 [list [get_pins {ClockBlock/dclk_glb_3}]]

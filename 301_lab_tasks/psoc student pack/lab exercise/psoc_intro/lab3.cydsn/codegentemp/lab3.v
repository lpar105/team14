...
module ADC_SAR_v3_10_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("6373ab8f-1b02-4bb6-ab24-8878559d53e3/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__circuit_input_net;
	wire [0:0] tmpFB_0__circuit_input_net;
	wire [0:0] tmpIO_0__circuit_input_net;
	wire [0:0] tmpINTERRUPT_0__circuit_input_net;
	electrical [0:0] tmpSIOVREF__circuit_input_net;

	cy_psoc3_pins_v1_10
		#(.id("9d2d5a9d-d772-43d6-bc12-a3e317752b2c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		circuit_input
		 (.oe(tmpOE__circuit_input_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__circuit_input_net[0:0]}),
		  .analog({Net_181}),
		  .io({tmpIO_0__circuit_input_net[0:0]}),
		  .siovref(tmpSIOVREF__circuit_input_net),
		  .interrupt({tmpINTERRUPT_0__circuit_input_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__circuit_input_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

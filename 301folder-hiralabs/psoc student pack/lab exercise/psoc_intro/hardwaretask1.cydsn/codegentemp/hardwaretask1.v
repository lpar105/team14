...
module ADC_SAR_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("e4b62c01-a613-4b73-a85c-c3db4d901310/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("166666333.334"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_385),
	...
	cy_psoc3_pins_v1_10
		#(.id("e4b62c01-a613-4b73-a85c-c3db4d901310/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
